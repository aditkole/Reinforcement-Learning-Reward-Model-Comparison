...
class DoorKeyRewardWrapper(GymnaxWrapper):
    """
    Wrapper to modify the intrinsic reward function.
    """
    ...
    def step(
        ...
        # --- CUSTOM REWARD LOGIC ---
        # Modify 'reward' here based on 'obs', 'state', 'action', etc.
        # e.g., reward = reward + 0.1
